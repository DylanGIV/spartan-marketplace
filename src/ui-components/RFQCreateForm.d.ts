...
export declare type RFQCreateFormInputValues = {
...
export declare type RFQCreateFormOverridesProps = {
    RFQCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type RFQCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: RFQCreateFormInputValues) => RFQCreateFormInputValues;
    onSuccess?: (fields: RFQCreateFormInputValues) => void;
    onError?: (fields: RFQCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: RFQCreateFormInputValues) => RFQCreateFormInputValues;
    onValidate?: RFQCreateFormValidationValues;
} & React.CSSProperties>;
export default function RFQCreateForm(props: RFQCreateFormProps): React.ReactElement;
